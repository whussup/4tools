...
tarOptions=" --preserve-permissions --create --absolute-names --totals --ignore-failed-read --xattrs --xattrs-include='*.*' --numeric-owner"
...
default_exclude_pattern="*.iso *.divx *.flv *.mp3 *.mp4 *.mkv *.flac *.opus"
